...
# 33 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\xc.h" 3
...
typedef struct{
    pin_config_t rowPins[4];
    pin_config_t colPins[6];
    keypad_connection_t conn;
    uint8_t (*keypadMatrix)[4][6];
