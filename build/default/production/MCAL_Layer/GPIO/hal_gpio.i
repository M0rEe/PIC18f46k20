    ...
    if(((void*)0) == pin_config){
      ...
      switch(pin_config->direction){
          case GPIO_DIRECTION_OUTPUT:
              (*(tris_regs[pin_config->port]) &= ~(0x01 << pin_config->pin));
              break;
...
STD_ReturnType gpio_pin_get_direction_status(const pin_config_t *pin_config,direction_t *direction_status )
{
    ...
    if(((void*)0) == pin_config || ((void*)0) == direction_status){
        ...
        *direction_status = ((*(tris_regs[pin_config->port]) >> pin_config->pin) & 0x01);
    }
    return ret;
}
STD_ReturnType gpio_pin_write_logic(pin_config_t *pin_config,logic_t logic)
{
    ...
    if(((void*)0) == pin_config){
      ...
      switch(logic){
          case GPIO_LOW:
              (*(lat_regs[pin_config->port]) &= ~(0x01 << pin_config->pin));
...
STD_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config,logic_t* logic)
{
    ...
    if(((void*)0) == pin_config || ((void*)0) == logic){
        ...
        *logic = ((*(port_regs[pin_config->port]) >> pin_config->pin) & 0x01);
    }
    return ret;
}
