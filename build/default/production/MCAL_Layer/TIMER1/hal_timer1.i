...
# 30 "MCAL_Layer/TIMER1/../GPIO/../mcal_std_types.h"
...
# 26 "MCAL_Layer/TIMER1/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
static __attribute__((inline)) void ModeSelect(const Timer1_t * obj);
static __attribute__((inline)) void RegSelect(const Timer1_t * obj);
static __attribute__((inline)) void OscSelect(const Timer1_t * obj);
...
STD_ReturnType Timer1_Init(const Timer1_t* obj) {
    ...
    if (((void*)0) == obj) {
        ...
        (T1CONbits.TMR1ON = 0);
        ModeSelect(obj);
        (T1CONbits.T1CKPS = obj->PrescalerValue);
